...
namespace Loiloc.Controllers.Display.Section.contact
{
    public class contactController : Controller
    {
        ...
        {
            ViewBag.Title = "<title>Liên hệ tới Loiloc.com</title>";
            ViewBag.Description = "<meta name=\"description\" content=\"Lõi lọc nước chính hãng. Khách hàng liên hệ mua Lõi lọc nước giá rẻ nhất\"/>";
            ViewBag.Keyword = "<meta name=\"keywords\" content=\"Mua Lõi lọc nước, liên hệ mua Lõi lọc nước, địa chỉ mua Lõi lọc nước\" /> ";
