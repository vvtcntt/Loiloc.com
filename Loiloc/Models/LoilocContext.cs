...
using Loiloc.Models.Mapping;

namespace Loiloc.Models
{
    public partial class LoilocContext : DbContext
    {
        static LoilocContext()
        {
            Database.SetInitializer<LoilocContext>(null);
        }

        public LoilocContext()
            : base("Name=LoilocContext")
        {
        }
        ...
        public DbSet<tblGuarantee> tblGuarantees { get; set; }
        ...
        public DbSet<tblUP> tblUPS { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new tblGuaranteeMap());
            ...
            modelBuilder.Configurations.Add(new tblTagMap());
            modelBuilder.Configurations.Add(new tblUPMap());
