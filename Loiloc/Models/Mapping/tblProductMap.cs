...
namespace Loiloc.Models.Mapping
{
    public class tblProductMap : EntityTypeConfiguration<tblProduct>
    {
        public tblProductMap()
        {
            ...
            this.Property(t => t.PriceString)
                .HasMaxLength(1000);

            this.Property(t => t.PriceSaleString)
                .HasMaxLength(500);
            ...
            this.Property(t => t.Func).HasColumnName("Func");
            ...
            this.Property(t => t.PriceString).HasColumnName("PriceString");
            this.Property(t => t.PriceSale).HasColumnName("PriceSale");
            this.Property(t => t.PriceSaleString).HasColumnName("PriceSaleString");
